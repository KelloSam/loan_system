defmodule LoanSystem.Clients.Client do
  use Ecto.Schema
  ...
  ## Examples
      ...
      iex> alias LoanSystem.Clients.Client
  ...
  schema "clients" do
    ...
    has_many :loans, LoanSystem.Loans.Loan
  ...
  @type t() :: %__MODULE__{
    ...
    loans: [LoanSystem.Loans.Loan.t()] | Ecto.Association.NotLoaded.t()
  }
