defmodule MiwayCreditCore.Loans do
  ...
  alias MiwayCreditCore.Loans.{Loan, Payment, Collateral, InterestCalculator}
  ...
  See `MiwayCreditCore.Loans.InterestCalculator.calculate/1` for the returned map keys.
  """
  ...
  "overdue". Called periodically by MiwayCreditCore.ArrearsScheduler; also
  ...
  # Accepts either the MiwayCreditCore.Repo module or the repo passed inside Ecto.Multi.
