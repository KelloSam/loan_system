...
config :loan_system, LoanSystem.Repo,
  ...
  hostname: "localhost",
  port: 5433,
  database: "loan_system_test#{System.get_env("MIX_TEST_PARTITION")}",
...
# LoanSystem.Loans.mark_overdue_payments/0 is unit-tested directly.
config :loan_system, LoanSystem.ArrearsScheduler, enabled: false
