defmodule MiwayCreditCore.DataCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import MiwayCreditCore.DataCase
    end
  end
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(MiwayCreditCore.Repo, shared: not tags[:async])
